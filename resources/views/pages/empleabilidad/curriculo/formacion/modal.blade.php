<form class="kt-form" action="{{ route('empleabilidad_curriculo.formacion.store') }}" method="post" id="form_empleabilidad_curriculo_formacion">
...
<script src="{{ asset('scripts/empleabilidad/curriculo/formacion/modal.js') }}" type="text/javascript"></script>
