<form class="kt-form" action="{{ route('empleabilidad_curriculo.complementaria.store') }}" method="post" id="form_empleabilidad_curriculo_complementaria">
...
<script src="{{ asset('scripts/empleabilidad/curriculo/complementaria/modal.js') }}" type="text/javascript"></script>
