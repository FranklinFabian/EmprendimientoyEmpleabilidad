<form class="kt-form" action="{{ route('empleabilidad_curriculo.competencia.store') }}" method="post" id="form_empleabilidad_curriculo_competencia">
...
<script src="{{ asset('scripts/empleabilidad/curriculo/competencia/modal.js') }}" type="text/javascript"></script>
