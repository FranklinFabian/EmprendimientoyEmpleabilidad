<form class="kt-form" action="{{ route('empleabilidad_curriculo.experiencia.store') }}" method="post" id="form_empleabilidad_curriculo_experiencia">
...
<script src="{{ asset('scripts/empleabilidad/curriculo/experiencia/modal.js') }}" type="text/javascript"></script>
