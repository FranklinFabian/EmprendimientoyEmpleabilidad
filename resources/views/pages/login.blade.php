...
<head>
    ...
    {{-- Favicon --}}
    <link rel="shortcut icon" href="{{ asset('storage/sanjose.png') }}" />
            ...
            <div class="d-flex flex-row-fluid flex-column justify-content-between">
                ...
                <div class="d-flex flex-column-fluid flex-column flex-center mt-5 mt-lg-0">
                    ...
                    <a href="#" class="mb-15 text-center">
                        <img src="{{ asset('storage/childfund.jpeg') }}" class="max-h-100px" alt="" />
                        <img src="{{ asset('storage/sanjose.png') }}" class="max-h-100px" alt="" />
                    </a>
                    <!--begin::Signin-->
                    ...
                    <div class="login-form login-signup">
                        ...
                        <form class="form" method="post" action="{{ route('autenticacion.store') }}" id="form_register">
                            ...
                            <div class="form-group py-3 border-bottom m-0">
                                <input class="form-control h-auto border-0 px-0 placeholder-dark-75" type="text" placeholder="Nombres" name="item[nombres]" autocomplete="off" />
                            </div>
                            <div class="form-group py-3 border-bottom m-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group py-3 border-bottom m-0">
                                        <input class="form-control h-auto border-0 px-0 placeholder-dark-75" type="password" placeholder="Confirmar contraseña" name="item[confirmar]" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group d-flex flex-wrap flex-center">
                                ...
                                <button id="kt_login_signup_cancel" class="btn btn-outline-primary font-weight-bold px-9 py-4 my-3 mx-2">Cancelar</button>
                            </div>
                        </form>
                        <!--end::Form-->
                    </div>
                ...
                <div class="d-flex flex-column-auto justify-content-between mt-15">
                    <div class="text-dark-50 font-weight-bold order-2 order-sm-1 my-2">© {{ date("Y") }} EMPRENDIMIENTO</div>
                </div>
        ...
        <div class="order-1 order-lg-2 flex-column-auto flex-lg-row-fluid d-flex flex-column p-7" style="background-image: url( {{ asset('media/bg/bg-4.jpg') }});">
            ...
            <div class="d-flex flex-column-fluid flex-lg-center">
                <div class="d-flex flex-column justify-content-center">
                    <h3 class="display-3 font-weight-bold my-7 text-white">PLATAFORMA LURIRI</h3>
                    <p class="font-weight-bold font-size-h3 text-white opacity-80">PROGRAMA DE EMPLEABILIDAD Y EMPRENDIMIENTO</p>
                </div>
            </div>
            <!--end::Content body-->
        </div>
